...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<table class=\"table hoverTable sidebar-index-table\">\n    <tr class=\"no-hover\">\n        <th></th>\n        <th>\n            <h3 class=\"h3-small\" style=\"margin-top:0px; margin-bottom:0px;\">\n                <font color=\"red\"> Red Flags </font>\n            </h3>\n        </th>\n    </tr>\n\n            ");
  ...
  data.buffer.push("\n\n\n\n            <tr class=\"no-hover\" style=\"border-bottom: 1px dashed grey;\"><td colspan=\"3\"></tr>\n            <tr class=\"no-hover\">\n                <td></td>\n                <td><h3 class=\"h3-small\" style=\"margin-top:0px; margin-bottom:0px;\"><font color=\"red\"> Additional Red Flags </font></h3></td>\n            </tr>\n            \n            ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.ToggleRowView", {hash:{
  ...
  data.buffer.push("\n\n            <tr class=\"no-hover\"><td colspan=\"3\">\n                <button class=\"btn btn-success\" ");
...
function program1(depth0,data) {
  ...
  data.buffer.push("    <div class=\"modal fade\" id=\"linkModal\" tabindex=\"-1\" role=\"dialog\" aria-hidden=\"true\">\n        <div class=\"modal-dialog\">\n            <div class=\"modal-content\">\n                <div class=\"modal-header\">\n                    <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n                    <h4 class=\"modal-title\">Links to Appearances</h4>\n                </div>\n                <div class=\"modal-body\">\n                    ");
...
function program1(depth0,data) {
  ...
  },hashTypes:{'class': "STRING",'placeholder': "STRING",'value': "ID",'style': "STRING",'insert-newline': "STRING"},hashContexts:{'class': depth0,'placeholder': depth0,'value': depth0,'style': depth0,'insert-newline': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "focus-input", options))));
  data.buffer.push("\n                            </div>\n                        </div>\n\n                        <ul class=\"nav navbar-nav navbar-right\">\n\n                            <li class=\"dropdown yamm\" id=\"big-dropdown\">\n                                <a class=\"btn btn-default navbar-btn dropdown-toggle\" id=\"big-dropdown-button\" data-toggle=\"dropdown\"> Red Flag Filters </b></a>\n                                    <ul class=\"dropdown-menu dropdown-menu-animated\" style=\"width:65%;\">\n                                        <li>\n                                            <div class=\"yamm-content\">\n                                                ");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("        <div class=\"modal fade\" id=\"sarModal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"sarModelLabel\" aria-hidden=\"true\" style=\"z-index:-1;\">\n          <div class=\"modal-dialog\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-hidden=\"true\">&times;</button>\n                <h4 class=\"modal-title\" id=\"sarModalLabel\">Generate Suspicious Activity report for: <br> ");
...
function program1(depth0,data) {
  ...
  data.buffer.push("        <table class=\"table\" id=\"uniqueRecordsTable\">\n            <tr><th> Date </th><th> Name </th><th> SIC </th><th> State </th></tr>\n            ");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<h1>  Promotion placeholder </h1>\n");
...
function program7(depth0,data) {
  ...
  data.buffer.push(escapeExpression((helper = helpers.input || (depth0 && depth0.input),options={hash:{
    ...
    'placeholder': ("Filter")
  },hashTypes:{'class': "STRING",'value': "ID",'style': "STRING",'insert-newline': "STRING",'placeholder': "STRING"},hashContexts:{'class': depth0,'value': depth0,'style': depth0,'insert-newline': depth0,'placeholder': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "input", options))));
...
function program7(depth0,data) {
  ...
  data.buffer.push("    <!-- Late Filing History -->\n        <center>\n            ");
...
function program17(depth0,data) {
  ...
  data.buffer.push("        <div class=\"container\" style=\"width:100%\">\n\n            <div class=\"row-fluid\">\n                <nav class=\"navbar\" style=\"border: 1px solid grey;\">\n                    <div class=\"col-sm-6\">\n                        <h1 style=\"margin-top:0px;\"> ");
  stack1 = helpers._triageMustache.call(depth0, "currentName", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push(" </h1>\n                    </div>\n                    <div class=\"col-sm-2\">\n                        <center>\n                            <h4 style=\"color:greyl\"> ");
...
function program1(depth0,data) {
  ...
  data.buffer.push("<td style=\"color:grey;\">\n    <i class=\"fa fa-square-o fa-1x\" style=\"color:grey\"></i>\n</td>\n\n<td style=\"color:grey;\">\n    ");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("<div class=\"row-fluid\" id=\"div-dropdown\">\n    <div class=\"col-md-7\">\n        <form>\n            ");
...
function program1(depth0,data) {
  ...
  var buffer = '';
  data.buffer.push("\n            \n        <div style=\"background-color:white; border: 1px solid black; width:50%; margin-top:30px;\">\n            <h3 class=\"h3-small\"> - Search By Red Flags - </h3>\n            <table class=\"table hoverTable front-page\">\n                <tr class=\"no-hover\">\n                    <th> </th>\n                    <th>\n                        <h3><font color=\"red\"> Red Flags </font></h3>\n                    </th>\n                </tr>\n\n                ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.ToggleRowView", {hash:{
    'text': ("Company has no business, no revenues and no product."),
    'valueBinding': ("toggles.financials")
  ...
  data.buffer.push("\n\n        \n\n                <tr class=\"no-hover\" style=\"border-bottom: 1px dashed grey;\"><td></td><td></td></tr>\n                <tr class=\"no-hover\">\n                    <td></td>\n                    <td><h3><font color=\"red\"> Additional Red Flags </font></h3></td>\n                </tr>\n                        \n                ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.ToggleRowView", {hash:{
    'text': ("Company stock has experienced recent price and/or volume anomalies."),
    'valueBinding': ("toggles.pv")
  },hashTypes:{'text': "STRING",'valueBinding': "ID"},hashContexts:{'text': depth0,'valueBinding': depth0},contexts:[depth0],types:["ID"],data:data})));
  ...
  data.buffer.push("<div style=\"margin-top:-65px;\">\n    <center>\n        <font color=\"red\">\n            <h1 style=\"margin-top:-10px;\"> Phronesis </h1>\n            <h2 style=\"margin-top:-5px;\"> Suspicious Activity Explorer </h2>\n            <h2 style=\"margin-top:-10px;\"> Penny Stocks </h2>\n        </font>\n            \n        <div style=\"width:50%;\">\n            <h3 class=\"h3-small\" style=\"padding-top:10px;\"> - Search By Company Name or Ticker - </h3>\n            ");
  data.buffer.push(escapeExpression((helper = helpers['focus-input'] || (depth0 && depth0['focus-input']),options={hash:{
    'class': ("input-fat"),
    'value': ("searchTerm"),
    'style': ("text-align:center;"),
    'insert-newline': ("companySearch")
  },hashTypes:{'class': "STRING",'value': "ID",'style': "STRING",'insert-newline': "STRING"},hashContexts:{'class': depth0,'value': depth0,'style': depth0,'insert-newline': depth0},contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "focus-input", options))));
  data.buffer.push("\n        </div>\n\n        ");
...
function program5(depth0,data) {
  ...
  data.buffer.push("    <!-- Google News Plugin -->\n		<div id=\"google-news\"></div>\n        <div class=\"row\">\n            <div class=\"col-sm-2\">\n                ");
...
function program4(depth0,data) {
  ...
  data.buffer.push("        <div class=\"accordion-group\">\n            <div class=\"accordion-heading\">\n                ");
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("        <div class=\"omx-wrapper\">\n            <div class=\"omx-head\">\n                ");
...
function program12(depth0,data) {
  ...
  data.buffer.push("\n                                        <li class=\"iterator disabled\"><a>&laquo;</a></li>\n                                    ");
  }
...
function program16(depth0,data) {
  ...
  data.buffer.push("\n                                        <li class=\"iterator disabled\"><a>&raquo;</a></li>\n                                    ");
  }
...
function program18(depth0,data) {
  ...
  data.buffer.push("        <div class=\"col-sm-4\" style=\"padding-left:0px; padding-right:0px;\">\n                ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </div>\n        <div class=\"col-md-8\" style=\"min-width: 275px\">\n            ");
  stack1 = helpers._triageMustache.call(depth0, "outlet", {hash:{},hashTypes:{},hashContexts:{},contexts:[depth0],types:["ID"],data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n        </div>\n\n");
  return buffer;
...
function program1(depth0,data) {
  ...
  data.buffer.push("\n        <i class=\"fa fa-check-square-o fa-1x\" style=\"color:red\"></i>\n    ");
  }
...
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  ...
  data.buffer.push("        <div>\n            <div id=\"container-ttschart\" style=\"height:500px; min-width: 200px;\"></div>\n        </div>\n");
...
function program7(depth0,data) {
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("</i> </h2>\n            \n            <div>\n                <h3 style=\"color: red;\"> Topic Trends Over Time </h3>\n                ");
  ...
  data.buffer.push("\n            </div>\n            <hr>\n\n            <div>\n                <h3 style=\"color: red;\"> Red Flag Summary </h3>\n\n                <h4> ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push(")% had one or more FINRA red flags. </h4>\n\n                <table class=\"table table-hover\" style=\"width:75%; margin-top:10px; text-align:center;\">\n                    <tr style=\"font-weight:bold;\"><td>Type of Red Flag</td><td>Number of Offending Companies</td></tr>\n                    ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                </table>\n\n            </div>\n            <hr>\n            \n            <div>\n                <h3 style=\"color: red;\"> Industry Classification Summary </h3>\n                <div id=\"placeholder\" style=\"overflow:auto;\"></div>\n                ");
  data.buffer.push(escapeExpression(helpers.view.call(depth0, "App.TopicPieChartView", {hash:{
    'data': ("")
  },hashTypes:{'data': "ID"},hashContexts:{'data': depth0},contexts:[depth0],types:["ID"],data:data})));
  data.buffer.push("\n\n                <div class=\"accordion\" id=\"topic_sic_accordion\">\n                    <div class=\"accordion-group\">\n                        <div class=\"accordion-heading\">\n                            <a class=\"accordion-toggle\" data-toggle=\"collapse\" data-parent=\"#topic_sic_accordion\" href=\"#a1\"\n                                style=\"padding-bottom:30px;\">\n                            <center><h3>Show Counts of SICs</h3><center>\n                        </a>\n                    </div>\n                    <div id=\"a1\" class=\"accordion-body collapse out\">\n                        <div class=\"accordion-inner\">\n                            <table class=\"table table-hover\" style=\"width: 75%; margin-top: 10px;\">\n                                <tr><td>Securities Industry Classification</td><td>Count</td></tr>\n                                ");
  ...
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n                            </table>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <hr>\n            \n            <div>\n                <h3 style=\"color: red;\"> Topic Of Interest Companies with No SEC Filings </h3>\n                <table class=\"table table-hover\" style=\"width:75%; margin-top:10px; text-align:center;\">\n                    ");
